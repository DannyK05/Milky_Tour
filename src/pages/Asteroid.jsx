    ...
    return(
        <Belt>
            ...
            <div className="planet_profile">
                    <img className="animate__animated animate__bounce" src={""} alt="Asteroid belt" />
                    <h1 className="animate__animated animate__bounceInLeft">Asteroid Belt - Celestial Dodgeball </h1>
            </div>
            <Fact image={""} content = "Peer out your windows and witness the rocky neighbors of the solar system. These asteroids are like ancient travelers, remnants from the early days of our cosmic neighborhood. "/>
            <Fact image= {""} content = "Spot Ceres, the largest object in the asteroid belt and a dwarf planet in its own right. It's like an oasis in this cosmic desert, standing out amidst the asteroid crowd. "/>
            <Fact image= {""} content = "Learn about the Trojan asteroids, loyal companions that share orbits with Jupiter. It's like a celestial convoy, traveling in harmony with the mighty gas giant. "/>
