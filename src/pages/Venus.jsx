    ...
    return(
        <Planets >
            <section>
                ...
                <Fact image="./src/assets/Venus/venus_volcanoes.jpg" content = "If we could see through those thick clouds, you'd spot towering volcanoes and vast plains. Venus is like the solar system's mysterious beauty hiding behind a veil. "/>
