...
const Jupiter = () => {
    ...
    return(
        <Planets>
        <section>
            <p className="animate__animated animate__bounceInRight">Our celestial journey brings us to the grandeur of Jupiter, the largest planet in our solar system. Brace yourselves for a spectacle of swirling storms and colossal beauty.</p>
