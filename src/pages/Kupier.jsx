...
const Kupier = () => {
    return(
        <Belt>
            ...
            <Fact image={KupierBelt} content = "Wave hello to Pluto and other dwarf planets, the ambassadors of the Kuiper Belt. It's like a cosmic gathering of distant cousins, each with its own unique charm. "/>
