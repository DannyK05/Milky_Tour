...
const Explore = () => {
  return (
    ...
    <p className='md:w-[70ch] m-auto' >Welcome, space enthusiasts, to NASA's Milky Tour! </p>
    <p className='md:w-[70ch] m-auto'>I'm your virtual tour guide, and I'm thrilled to 
  ...
  <p className='md:w-[70ch] m-auto'>Enjoy panoramic views of space with our improved observation windows, providing an immersive experience as we cruise through the cosmos.</p>
  <p className='md:w-[70ch] m-auto'>Immerse yourself even further with virtual reality tours of each celestial destination, enhancing your understanding and appreciation of the wonders beyond.</p>
   <p className='md:w-[70ch] m-auto'>You can also relax in zero-gravity lounges during the journey, offering a unique and comfortable space experience.</p>
    </div>
      <br />
    <p className='md:w-[70ch] m-auto'>Now, before we take off, let's don our Special Intra-Vehicular Activity (IVA) suits.</p>
