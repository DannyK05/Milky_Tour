...
const Pluto = () => {
    return(
        ...
        <Visor id="7"/>
            ...
            <p className="greet">As we bid farewell to Pluto, we're gearing up for the return journey to Earth. But fear not, fellow explorers! On our way back, you'll have the special opportunity to revisit your favorite celestial destinations. So, fasten your seat belts once more, and let's make our way home with memories of a Milky Tour that's truly out of this world! 🌌🌍🚀</p>
        </section>
       <Link to="/return" ><button>Back to earth</button></Link>
    </Planets>
    )
