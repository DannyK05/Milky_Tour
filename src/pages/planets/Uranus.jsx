...
const UranusPage = () => {
  return (
    ...
    and offset from the planet' center. This creates a lopsided magnetic bubble that  
    ...
    ensemble in Uranus' cosmic drama."
        />

        <p className="greet">
          Hold on tight as we harness Uranus&apos; gravitational pull for a
          final boost. Our next destination lies at the edge of the solar system
