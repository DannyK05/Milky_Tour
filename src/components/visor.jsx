...
const Visor = (props) => {
  ...
  return (
    <section
      ...
      } fixed px-5 top-[30%] md:left-[20%] border-4 z-10 w-full md:w-[70%] flex justify-between items-center flex-col`}
    >
      ...
      <div className="info flex border-x-0 py-2 border w-full items-center justify-between">
        <span className="position flex flex-col align-center lg:w-1/5  ">
        ...
        <span className="temp  flex flex-col items-center w-1/3 lg:w-1/5 ">
        ...
        <span className="size  flex flex-col items-center w-1/3 lg:w-1/5 ">
          <h2 className="inline">Size:</h2>
          <p>{body.size.toLocaleString()}km</p>
        </span>

        <span className="time flex flex-col items-center w-full mt-2 lg:w-1/4 lg:mt-0 ">
